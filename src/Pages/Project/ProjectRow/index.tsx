import { ArtProjectRowProps } from "./type"
...
import { FPrimaryButton, FSecondaryButton } from "@fantaskticedtechlimited/fui-complib"

function ArtProjectRow(props: ArtProjectRowProps) {
	...
	const artist = props.artistList.find(e => e.artistAddress === props.artProject.artistAddress)
	return (
		<div className={styles.topicRowDiv()}>
			...
			>
				<FSecondaryButton
					...
					onClick={props.onFundTheProject}
				>
					Fund the project
				</FSecondaryButton>
